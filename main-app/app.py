...
def get_product_info(product_id):
    ...
    if request.args.get('format') == 'json':
        return jsonify({"data":combine_response,"message":"Fetch Data Successfully" if product else "Failed to fetch data"})


    return render_template('product.html', **combine_response)
